...
export default function CyberCircleC({
	className = "",
	classNameSvg = "",
	delay = 0.64,
	speed = -3.5,
...
return (
  <FadeIn_01
    ...
    stiffness={stiffness} 
  >
	<svg viewBox="-20 -20 240 240" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${classNameSvg} overflow-visible animate-spin-C`}>
