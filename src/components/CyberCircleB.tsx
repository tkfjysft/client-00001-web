...
export default function CyberCircleB({
	className = "",
	classNameSvg = "",
	delay = 0.56,
	speed = 0.7,
...
return (
  ...
  >
	<svg viewBox="-20 -20 240 240" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${classNameSvg} overflow-visible animate-spin-B`}>
		{/* 外郭層：極太かつ長大な弧を複数配置 */}
